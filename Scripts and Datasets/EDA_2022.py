...
# - EDA for Final_Dataset_Raw_2022.csv (2000–2022)
# ============================================================
...
# Config
# ============================================================
DATA_PATH = "Final_Dataset_Raw_2022.csv"
START_YEAR = 2000
END_YEAR = 2022
...
def require_cols(df: pd.DataFrame, cols: list[str], context: str = ""):
...
require_cols(df_corr, NUM_COLS, context="Correlation")
...
# Save results (same folder as script)
corr_matrix.to_csv("Correlation_Matrix_NoYear_2000_2022.csv")
strength_df.to_csv("Correlation_Strength_Categories_NoYear_2000_2022.csv", index=False)

print("\nSaved correlation outputs (2 files).")

# ============================================================
# PART 2 — EDA (2000–2022)
# ============================================================
print(f"\n================ EDA ON {START_YEAR}–{END_YEAR} DATASET ================")

df = read_csv_dedup(DATA_PATH)
require_cols(df, ["Year", "Country_ID", "Income group"] + NUM_COLS, context="EDA")
